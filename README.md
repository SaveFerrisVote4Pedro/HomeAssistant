...
* Notifies me if the car's windscreens might have ice on them (based on a trigger formula using time of day, humidity, temperature and wind speed overnight and in the morning)
