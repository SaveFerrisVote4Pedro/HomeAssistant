...
* "Good morning" annoucements of weather forecast, UV forecast (only if it is above 5), current rain, air quality, car driving range and drive time to work. Announcement is triggered when someone enters the kitchen in the morning after 7am (or after 9am on weekends and school holidays)
